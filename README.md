...
```gradle
plugins {
    id "cj.gradle.EmbeddedTools" version "<latest version>"
}
```

See [https://plugins.gradle.org/plugin/cj.gradle.EmbeddedTools](https://plugins.gradle.org/plugin/cj.gradle.EmbeddedTools) for the latest version

## Spec

```gradle
import cj.gradle.toolchains.*
import cj.gradle.nativedeps.*
